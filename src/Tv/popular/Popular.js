...
export class TPopular extends Component {
  constructor(props) {
    super(props);
    this.state = {
      movies: [],
  ...
  _loadMore = async e => {
    ...
    try {
      const res = await fetch(
        `https://api.themoviedb.org/3/tv/popular?api_key=222e7bb2f5b52cf29c95ea61cc204128&language=en-US&page=${this.state.page}`
      );
