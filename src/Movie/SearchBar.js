...
import { Navbar, FormGroup, FormControl, Button, Image, Row, Col } from 'react-bootstrap'
...
class SearchBar extends Component {
  ...
  return (
    <Navbar bsStyle='inverse'>
      <Navbar.Header>
        <Navbar.Brand>
          <a href="#"><span style={brandStyle}>{this.props.brand}</span><Image style={imgStyle} src={logo}/></a>
        </Navbar.Brand>
      </Navbar.Header>
